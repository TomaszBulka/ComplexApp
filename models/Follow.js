...
Follow.prototype.validate = async function(action){
    ...
    } else {this.errors.push("You can not follow a user that does not exist") 
                }
    ...
    if(action =="delete"){
        if(!doesFollowAlreadyExists){this.errors.push("You can not stop following someone ypu do not already follow")}            
    }
