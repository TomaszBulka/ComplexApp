    ...
    return new Promise(async(resolve,reject) =>{
        ...
        try{
            ...
            if(post.isVisitorOwner){
               ...
               await postsCollection.deleteOne({_id: ObjectID(postIdtoDelete)})
               resolve()
            }else{
                reject()
            }
...
Post.getFeed = async function(id){
    ...
    // look for posts where the author is in the abve array of followed users
    return Post.reusablePostQuery([
